...
const offices = [
  { id: 1, city: 'Kinshasa', address: ['4556 Brendan Ferry', 'Kinshasa, CA 90210'] },
  { id: 2, city: 'Goma (Coming Soon)', address: ['886 Walter Streets', 'Goma, NY 1c2345'] },
  { id: 3, city: 'Lubumbashi (Coming Soon)', address: ['7363 Cynthia Pass', 'Lubumbashi, ON N3Y 4H8'] },
  { id: 4, city: 'Kisangani (Coming Soon)', address: ['167 Kins Lane', 'Kisangani N1 2EF'] },
  { id:  5, city: 'Gbadolite (Coming Soon)', address: ['1674 Cobble Lane', 'Gbadolite N1 2EF'] },

  { id: 6, city: 'Mbujimayi (Coming Soon)', address: ['1567 Mbuji Lane', 'Mbujimayi N1 2EF'] },
     ...
     <main className="overflow-hidden">
      ...
      <div className="bg-warm-gray-50">
        <div className="py-24 lg:py-32">
          <div className="relative z-10 mx-auto max-w-7xl pl-4 pr-8 sm:px-6 lg:px-8">
            ...
            Whether you have questions, ideas, or collaboration in mind, we're here to listen. Reach out and let's explore the endless 
            possibilities together. Your journey to innovation starts with a simple message.
            </p>
          </div>
        </div>
      </div>
          ...
          <div className="relative bg-white shadow-xl">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3">
              ...
              <div className="relative overflow-hidden bg-gradient-to-b from-teal-500 to-teal-600 py-10 px-6 sm:px-10 xl:p-12">
                ...
                Our customer support team is available, you can WhatsApp us or email us on
                ...
                <dl className="mt-8 space-y-6">
                  ...
                  <dd className="flex text-base text-teal-50">
                    ...
                    <span className="ml-3">+243 (0) 999 999 146</span>
                  </dd>
                  <dt>
                  ...
                  <dd className="flex text-base text-teal-50">
                    ...
                    <span className="ml-3">info@maticent.com
</span>
                  </dd>
                </dl>
      ...
      <section aria-labelledby="offices-heading">
        <div className="mx-auto max-w-7xl py-24 px-6 sm:py-32 lg:px-8">
          ...
          Headquated in the Democratic Republic of Congo Kinshasa, we have our assembling factory at Limeté and our Stores in the business center
