...
const products: Product[] = [
  {
    ...
    weight: "7kgs",
    inputOutput: "4*USB2.0+2*USB3.0\n1*Type-C+1*4G LTE\n1*VGA/COM+1*HDMI OUT\n1*RJ45+1*Audio In & Out",
    batteryTime: "External 120W UPS Battery, Up to 3 hours",
    otherFeatures: "Bluetooth 5.2, 2.4G/5G, WIFI 802.11a/b/g/n/ac, 4G LTE\nSpeaker: 3w High-fidelity Speakers\nCamera: Built-in 3.0M Camera & Dual Mic\nMaterial: Alloy Base, Plastic Electroplating\nPower: 110-220V/100-240V",
  },
  {
    id: 2,
    productName: "Continuum",
...
interface ProductProps {
  ...
  const ContinuumProductComponent: React.FC<ProductProps> = ({ product }) => {
    return (
  ...
  export default ContinuumProductComponent;